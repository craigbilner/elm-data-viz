...
var _user$project$Data$lineData = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 2, _1: 90},
		{ctor: '_Tuple2', _0: 4, _1: 95},
		{ctor: '_Tuple2', _0: 12, _1: 7},
		{ctor: '_Tuple2', _0: 20, _1: 54},
		{ctor: '_Tuple2', _0: 25, _1: 69},
		{ctor: '_Tuple2', _0: 40, _1: 78},
		{ctor: '_Tuple2', _0: 45, _1: 48},
		{ctor: '_Tuple2', _0: 70, _1: 36}
	]);

var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Main$makeXValue = F5(
	function (xOffset, yOffset, margin, xPos, xValue) {
		return A2(
			_evancz$elm_graphics$Collage$move,
			{ctor: '_Tuple2', _0: xPos - xOffset, _1: (0 - yOffset) - margin},
			_evancz$elm_graphics$Collage$text(
				_evancz$elm_graphics$Text$fromString(
					_elm_lang$core$Basics$toString(xValue))));
	});
var _user$project$Main$makeValues = F3(
	function (min, max, step) {
		return (_elm_lang$core$Native_Utils.cmp(min, max) > -1) ? _elm_lang$core$Native_List.fromArray(
			[]) : A2(
			_elm_lang$core$List_ops['::'],
			min,
			A3(_user$project$Main$makeValues, min + step, max, step));
	});
var _user$project$Main$minMax = function (data) {
	var max = function () {
		var _p0 = _elm_community$list_extra$List_Extra$last(data);
	...
	var min = function () {
		var _p1 = _elm_lang$core$List$head(data);
	...
	return {ctor: '_Tuple2', _0: min, _1: max};
};
var _user$project$Main$makeXTick = F5(
	function (colour, tickHeight, xOffset, yOffset, xPos) {
		return A2(
			_evancz$elm_graphics$Collage$traced,
			_evancz$elm_graphics$Collage$solid(colour),
			_evancz$elm_graphics$Collage$path(
				_elm_lang$core$Native_List.fromArray(
					[
						{ctor: '_Tuple2', _0: xPos - xOffset, _1: 0 - yOffset},
						{ctor: '_Tuple2', _0: xPos - xOffset, _1: (0 - tickHeight) - yOffset}
					])));
	});
var _user$project$Main$xUnits = function (model) {
	var yOffset = (model.height / 2) - model.padding;
	var xOffset = (model.width / 2) - model.padding;
	var _p2 = _user$project$Main$minMax(model.data);
	var min = _p2._0;
	var max = _p2._1;
	var units = _elm_lang$core$Native_List.range(0, (model.width - (model.padding * 2)) / model.xTickSpread);
	var ticks = A2(
		_elm_lang$core$List$map,
		function (x) {
			return x * model.xTickSpread;
		},
		units);
	var values = A3(
		_user$project$Main$makeValues,
		min,
		max,
		(max - min) / _elm_lang$core$Basics$toFloat(
			_elm_lang$core$List$length(units)));
	return {
		ctor: '_Tuple2',
		_0: A2(
			_elm_lang$core$List$map,
			A4(_user$project$Main$makeXTick, model.axisColour, model.xTickHeight, xOffset, yOffset),
			ticks),
		_1: A3(
			_elm_lang$core$List$map2,
			A3(_user$project$Main$makeXValue, xOffset, yOffset, model.xTickValueMargin),
			ticks,
			values)
	};
};
var _user$project$Main$calculateXAxis = function (_p3) {
	var _p4 = _p3;
	var _p6 = _p4.width;
	var _p5 = _p4.padding;
	var originY = ((0 - _p4.height) / 2) + _p5;
	var xEnd = {ctor: '_Tuple2', _0: (_p6 / 2) - _p5, _1: originY};
	var originX = ((0 - _p6) / 2) + _p5;
	var xStart = {ctor: '_Tuple2', _0: originX, _1: originY};
	return A2(
		_evancz$elm_graphics$Collage$traced,
		_evancz$elm_graphics$Collage$solid(_p4.axisColour),
		_evancz$elm_graphics$Collage$path(
			_elm_lang$core$Native_List.fromArray(
				[xStart, xEnd])));
};
var _user$project$Main$calculateYAxis = function (_p7) {
	var _p8 = _p7;
	var _p10 = _p8.padding;
	var _p9 = _p8.height;
	var originY = ((0 - _p9) / 2) + _p10;
	var originX = ((0 - _p8.width) / 2) + _p10;
	var xStart = {ctor: '_Tuple2', _0: originX, _1: originY};
	var xEnd = {ctor: '_Tuple2', _0: originX, _1: (_p9 / 2) - _p10};
	return A2(
		_evancz$elm_graphics$Collage$traced,
		_evancz$elm_graphics$Collage$solid(_p8.axisColour),
		_evancz$elm_graphics$Collage$path(
			_elm_lang$core$Native_List.fromArray(
				[xStart, xEnd])));
};
var _user$project$Main$view = function (model) {
	var _p11 = _user$project$Main$xUnits(model);
	var xTicks = _p11._0;
	var xValues = _p11._1;
	var xAxis = _user$project$Main$calculateXAxis(model);
	var yAxis = _user$project$Main$calculateYAxis(model);
	var forms = _elm_lang$core$List$concat(
		_elm_lang$core$Native_List.fromArray(
			[
				xTicks,
				xValues,
	...
	return _evancz$elm_graphics$Element$toHtml(
		A3(
			...
			_elm_lang$core$Basics$round(model.width),
			_elm_lang$core$Basics$round(model.height),
			forms));
};
...
var _user$project$Main$initModel = {height: 750, width: 1000, padding: 100, axisColour: _elm_lang$core$Color$black, xTickHeight: 10, xTickSpread: 50, xTickValueMargin: 20, data: _user$project$Data$lineData};
...
var _user$project$Main$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {height: a, width: b, padding: c, axisColour: d, xTickHeight: e, xTickSpread: f, xTickValueMargin: g, data: h};
	});
